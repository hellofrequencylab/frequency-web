...
-- color. The brand name/logo are wired into the Space header in a follow-up; the accent is a
-- convenience swatch operators can reference. Additive + idempotent (the spaces table ships
-- in 20260619000000_spaces_tenancy.sql).
--
...
comment on column public.spaces.brand_name is
  'Display brand name for this Space (falls back to spaces.name when null). Shown in the Space header — wired in a follow-up.';
comment on column public.spaces.brand_logo_url is
  'Same-origin or https URL of this Space''s brand logo. Shown in the Space header — wired in a follow-up.';
