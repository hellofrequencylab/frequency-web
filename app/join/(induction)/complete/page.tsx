// Deferred Funnel induction — completion landing (ADR-082 → ADR-1090).
// The signed-out flow sends the new member here AFTER sign-in; the client
...
import { CompleteFinalizer } from './finalizer'
