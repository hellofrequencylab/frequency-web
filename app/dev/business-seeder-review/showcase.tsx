...
export function ReviewBoardShowcase() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8">
      <div className="mb-6">
        <p className="eyebrow text-subtle">Dev showcase</p>
      ...
      <ReviewBoard intakeId="dev-fixture" initialModel={model} status="review" isDemo appliedSpaceId={null} initialMood="warm" initialImages={[]} initialImagePlan={[]} initialLockHero initialLockLayout={false} initialListed={false} initialDirections="" />
    </div>
  )
}
