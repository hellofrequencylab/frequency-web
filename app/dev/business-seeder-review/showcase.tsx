...
export function ReviewBoardShowcase() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8">
      ...
      <ReviewBoard intakeId="dev-fixture" initialModel={model} status="review" isDemo appliedSpaceId={null} initialMood="warm" initialImages={[]} initialImagePlan={[]} initialLockHero />
    </div>
  )
}
