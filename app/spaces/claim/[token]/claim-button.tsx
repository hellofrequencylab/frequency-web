  ...
  return (
    <div className="space-y-2">
      ...
      <button
        ...
        onClick={handleClaim}
        disabled={pending}
        className={`inline-flex w-full items-center justify-center gap-2 rounded-card bg-primary font-semibold text-on-primary lift-1 transition-colors hover:bg-primary-hover disabled:opacity-40 ${
