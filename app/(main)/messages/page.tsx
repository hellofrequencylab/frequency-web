                      ...
                      <li key={m.profile_id}>
                        ...
                        >
                          <div className="relative shrink-0">
                            {m.avatar_url ? (
                              <Image width={28} height={28} src={m.avatar_url} alt={m.display_name} className="w-7 h-7 rounded-full object-cover" />
                            ) : (
    ...
    >
      <div className="shrink-0">
        {isGroup ? (
          ...
          <Image width={40} height={40} src={conv.participants[0].avatar_url!} alt={conv.participants[0].display_name} className="w-10 h-10 rounded-full object-cover" />
        ) : (
  ...
  return (
    <div className="relative w-10 h-10">
      {shown.map((p, i) => {
        ...
        return p.avatar_url ? (
          <Image width={40} height={40} key={p.id} src={p.avatar_url} alt={p.display_name}
