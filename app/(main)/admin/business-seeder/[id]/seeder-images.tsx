        ...
        {images.map((url, i) => (
          <div key={url} className="group relative aspect-square overflow-hidden rounded-card border border-border">
            ...
            {roleByUrl.get(url) && roleByUrl.get(url) !== 'other' && (
              <span className="absolute bottom-1.5 left-1.5 rounded-pill bg-black/60 px-1.5 py-0.5 text-2xs font-medium capitalize text-white">
                {roleByUrl.get(url)}
              </span>
            )}
            <button
              ...
              className="absolute right-1.5 top-1.5 rounded-pill bg-black/60 p-1 text-white opacity-0 lift-1 transition-opacity hover:bg-black/80 focus:opacity-100 group-hover:opacity-100 disabled:opacity-60"
            >
            ...
            <div className="absolute inset-x-1.5 bottom-1.5 flex items-center justify-center gap-1 opacity-0 transition-opacity focus-within:opacity-100 group-hover:opacity-100">
              <button
                ...
                className="rounded-pill bg-black/60 p-1 text-white hover:bg-black/80 disabled:opacity-30"
              >
              ...
              {i !== 0 && (
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-pill bg-black/60 px-2 py-1 text-2xs font-semibold text-white hover:bg-black/80 disabled:opacity-60"
                >
