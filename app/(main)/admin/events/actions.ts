...
// Named tiers with richer pricing modes + inventory. The validation + service-role
// writes live in the shared lib/events/ticket-tiers module (the host-facing surface
// reuses the exact same logic); these actions add the admin authz gate + the admin
// revalidation. The `sold` count is billing-owned and never set here.
