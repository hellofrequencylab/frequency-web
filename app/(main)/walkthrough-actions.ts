...
import { dismissWalkthrough, completeWalkthrough } from '@/lib/walkthroughs/progress'
...
//
// There is deliberately NO seen action here: the seen mark is written fire-and-forget
// at server render by markWalkthroughSeen (components/walkthroughs/feed-walkthrough.tsx,
// feed-role-promotion.tsx), so a client action for it would be a double write.
