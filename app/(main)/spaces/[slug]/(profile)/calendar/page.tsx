...
//
// ADMIN / GUEST (ADR-1389, amended by ADR-1450 and ADR-1456). A viewer who manages the Space lands on
// ADMIN: the production console (CalendarPmConsole). Production is its own lane. The board lists what
// is penciled, in planning, and cancelled. StaffCalendar is the date map and the settings drawer, not
// a second guest month. A toggle flips to GUEST, which is exactly what a visitor sees. Every other
// viewer (guests and ordinary members) only ever gets Guest, and the server never loads the private
