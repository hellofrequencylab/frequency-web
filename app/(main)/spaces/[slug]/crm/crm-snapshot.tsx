...
export async function SpaceCrmSnapshot({ slug }: { slug: string }) {
  ...
  return (
    <section className="space-y-3 rounded-card border border-border bg-surface p-4 lift-1">
...
function CrmUpsell({
  ...
  return (
    <section className="rounded-card border border-border bg-surface p-4 lift-1">
