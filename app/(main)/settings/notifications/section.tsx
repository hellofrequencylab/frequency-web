...
// The Notifications SECTION of the unified Settings page (DAWN 2 screen pass). This is
// the server half that used to be app/(main)/settings/notifications/page.tsx, unchanged
// in behavior: the channels × topics grid (NotificationsForm), the SMS opt-in card
// (SmsForm), and the consent scopes (ConsentScopesForm). The old /settings/notifications
