...
//
// The Run folded into the Program tab (owner ruling, 2026-08-12): a Circle's practice, its calendar
// and its Journey are the same subject at three horizons, not three sibling tabs. The shared meter
// and the way into the Journey itself sit under ../program, in full, in the last section.
//
