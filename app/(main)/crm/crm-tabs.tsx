...
const TABS = [
  { href: '/crm', label: 'Pipeline', Icon: KanbanSquare, match: (p: string) => p === '/crm' || p.startsWith('/crm/deals') },
  { href: '/crm/contacts', label: 'Contacts', Icon: Users, match: (p: string) => p.startsWith('/crm/contacts') },
] as const
