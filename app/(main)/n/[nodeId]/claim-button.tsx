...
export function ClaimButton({ nodeId, secret }: { nodeId: string; secret?: string | null }) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 rounded-xl bg-primary hover:bg-primary-hover text-on-primary text-sm font-semibold px-5 py-3 lift-1 transition-colors disabled:opacity-60"
    >
