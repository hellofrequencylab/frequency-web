// Member event page. Signed-in visitors reach this file through a proxy rewrite
// from /events/<slug> to /events/<slug>/full (lib/nav/member-event-rewrite.ts).
// The public ISR body lives in ./page.tsx.
