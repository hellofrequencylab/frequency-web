...
// Sends the member to Stripe Checkout for CREW, the one sellable member tier (ADR-878). Rendered only
// when billing is configured; otherwise /upgrade shows the beta free toggle. It takes no tier prop:
// the member ladder is Member (free) and Crew, so there is one button and one thing it buys.
