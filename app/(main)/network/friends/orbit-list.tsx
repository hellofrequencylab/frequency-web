  ...
  return (
    <EmptyState
      ...
      action={
        <Link
          href="/people"
          className="inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-2.5 text-body-sm font-semibold text-on-primary lift-1 transition-colors hover:bg-primary-hover"
        >
          Find people
        </Link>
      }
