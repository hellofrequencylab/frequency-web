...
// Consolidated into /loneliness (Community Collective IA consolidation). The unique content and target
...
export default function WhatIsAThirdSpaceRedirect() {
  permanentRedirect('/loneliness')
}
