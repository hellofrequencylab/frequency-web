...
async function getOrganizerRoutes(): Promise<MetadataRoute.Sitemap> {
  try {
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/discover/journeys`, changeFrequency: "daily", priority: 0.8 },
    { url: `${SITE_URL}/discover/topics`, changeFrequency: "weekly", priority: 0.8 },
    { url: `${SITE_URL}/discover/partners`, changeFrequency: "weekly", priority: 0.8 },
    { url: `${SITE_URL}/discover/practices`, changeFrequency: "weekly", priority: 0.8 },
    ...
    { url: `${SITE_URL}/discover/spaces`, changeFrequency: "daily", priority: 0.8 },
    // Browse-by-place hub — the local-intent landing index (per-city pages are dynamic, below).
    { url: `${SITE_URL}/discover/places`, changeFrequency: "daily", priority: 0.8 },
    ...
    // lists them.
    { url: `${SITE_URL}/discover/cities`, changeFrequency: "daily", priority: 0.7 },
    ...
    { url: `${SITE_URL}/vs`, changeFrequency: "monthly", priority: 0.6 },
    ...COMPARISONS.map((c) => ({
    ...
    { url: `${SITE_URL}/loneliness`, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${SITE_URL}/how-to-be-more-social`, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${SITE_URL}/tools-for-community-builders`, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${SITE_URL}/help/changelog`, changeFrequency: "weekly", priority: 0.5 },
  ];
  ...
  try {
    ...
    const journeyRoutes: MetadataRoute.Sitemap = journeys.map((j) => ({
      ...
      ...((j.updated_at) ? { lastModified: new Date(j.updated_at) } : {}),
      changeFrequency: "weekly",
      priority: 0.6,
    }));
