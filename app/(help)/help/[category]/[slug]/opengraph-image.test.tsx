...
describe('the per-article help card', () => {
  ...
  it('and two articles in different categories differ even when neither exists', async () => {
    // The fallback is allowed to be identical — it is the group card's content by design — so this
    // pins the OTHER half: an unknown slug must still answer 200 with a card rather than throwing
    // and ending a production export (LIVE-084).
