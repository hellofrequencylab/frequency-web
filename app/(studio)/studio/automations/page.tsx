...
export default async function AutomationsPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-text mb-1">Automations</h1>
      <p className="text-sm text-muted leading-relaxed max-w-2xl mb-6">
        Rules that watch the event backbone and act. When a member triggers an event
        (a verified practice, a check-in, a join), the rule runs through the spine
        (queued, consent-checked). This is what the AI operator will later drive.
      </p>
