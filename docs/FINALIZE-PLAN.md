...
| **Visual regression** | ⏳ | baselines **recaptured 2026-08-10** (run #15, 62 of 72, zero additions); `pr-compare` evaluated against the fresh set for the first time on PR #2071 |
