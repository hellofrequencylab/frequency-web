...
**Fan-out that is safe today** (re-run `pnpm packets`; these ids move): **money** LIVE-410 closed (memberships on the free floor, ADR-1415) · **events** LIVE-376 closed (sole-Space default, ADR-1413) · **scan** LIVE-412 closed (app-shell composer + islands, ADR-1464; SCAN-636…641 already closed) · **hygiene** HYG-101 closed (parseInput ratchet, ADR-1420). Do not start a fifth agent on Journey sales.
