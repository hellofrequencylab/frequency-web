...
## 12. Production agents fan out from the one list. 🔒 `pnpm packets` (ADR-1412)
...
2. **New automation**.
3. **Name:** `Frequency backlog packets`.
...
**Fan-out that is safe today** (re-run `pnpm packets`; these ids move): **money** LIVE-410 closed (memberships on the free floor, ADR-1415) · **events** LIVE-376 closed (sole-Space default, ADR-1413) · **scan** SCAN-636…641 and LIVE-412 closed (`meta.slate.metaScanCleanup`; ADR-1464) · **hygiene** HYG-101 closed (parseInput ratchet, ADR-1420). Do not start a fifth agent on Journey sales while `cursor/cloud-agent-workspace-8978` is live.
