...
| 1.7 | **Workspace UI.** Recompose on the Dashboard template + faceted Index body: `StatCard` row, search box, facet rail, saved views. Rail via `page-chrome.ts`. | ⏳ in flight (PR #1212) |
| 1.8 | **DataTable call.** Extend the shared `DataTable` (ADR-233) vs. formalize the bespoke table — decided in-build. | ⏳ in flight (PR #1212) |
