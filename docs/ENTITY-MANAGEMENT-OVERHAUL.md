...
2. **Spaces harmonization depth** — fully retire the 7-tab vs. keep it as a thin compatibility
   wrapper over the shared spine. **Resolved (ADR-452):** a SPLIT, not a single answer. For the types
