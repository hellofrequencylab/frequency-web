...
- **If you run a Space, Production has its own lane on the Admin Calendar.** Pencil, Planning, and Cancelled stay on the board. The month grid is the date map underneath. Guest is still what visitors see.
