...
- **Mobile (built later, enabled now):** Expo/React Native — *primary* surface;
...
### Phase 1 — Web IA & framework *(strategy docs 1–2)*
...
- **Mobile is "build it in," not "bolt it on"** — every Phase 0–4 decision
...
These don't block any Phase 0–2 engineering — they can be answered as Phase 3
approaches.
