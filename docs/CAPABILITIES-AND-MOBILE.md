...
- Today: `createAdminClient()` (service role, **bypasses RLS**) + app-side authz
  ...
  per [Supabase docs](https://supabase.com/docs/guides/troubleshooting/why-is-my-service-role-key-client-getting-rls-errors-or-not-returning-data-7_1K9z).)
...
| **Design tokens** (W3C JSON → CSS vars *and* native constants) | (none) |
| Realtime channels (Supabase **Broadcast**, has web + native SDKs) | (none) |
