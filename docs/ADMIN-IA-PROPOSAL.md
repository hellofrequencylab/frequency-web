...
> ⚠️ **SUPERSEDED** by [`MENU-CONTRACT.md`](MENU-CONTRACT.md) (ADR-553, corrected by ADR-927), the locked source for the admin rail and `/manage` consoles, and by [`NAV-SYSTEM-REDESIGN.md`](NAV-SYSTEM-REDESIGN.md), which declared this proposal superseded on 2026-07-01. The "one missing line" below was added: `lib/nav-areas.ts` carries the `admin-crm` row (ADR-382 to 387), so the present-tense problem statement is history. Kept for history.
