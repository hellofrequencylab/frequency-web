...
| **Journey completion reward** | Finishing a Journey pays +75 Zaps + a Pillar Trophy. Replaces the old flat 30-Gem reward and the retired final-rank Gem bonus. The escalating per-Journey ladder this row once described (Initiate 25 / Adept 50 / Master 100) is itself RETIRED by ADR-305; LIVE-185 removed the code that was still paying it, so a third finish now pays the Certificate's 100 Gems and nothing more. |
