...
## Status
- [x] P0 · [x] P1 (console) · [x] P1b (rail) · [x] P2 (inline bodies + snapshots) · [x] P3 (Module Manager, console-fed) · [x] P3b (rail on the manifest + honors order/hidden) · [ ] P4 · [ ] P5
