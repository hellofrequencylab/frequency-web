...
| `components/layout/beta-countdown-banner.tsx` | "We are in Beta. The Founding Business deal is open through…" | 🟡 `betaEndsAt()` auto-hides. Reframed 2026-08-06: it announces an OFFER, not the end of free. |
