...
| IDEA-010 | 2026-06-29 | **Clean-start site audit** (bugs/wiring · perf · SEO-AIO · security). Mature codebase; 🔧 items fixed this sweep (security IDOR + bounds, event-warm-proof wiring, perf N+1s, SEO refinements), 📋 items triaged below. | claude | ⏳ 🔧 batches shipping; 📋 backlog open | full detail in [SITE-AUDIT-2026-06-29.md](SITE-AUDIT-2026-06-29.md) |
| IDEA-011 | 2026-06-29 | Backlog from the audit (📋): SEC-9/10 (event.ics hidden filter, parameterize searchMembersToLink), BUG-5/6 (wire `updateCircleField` inline edit + `draftOfferingBlurbAction`), BUG-9 (loading.tsx skeletons), PERF-8/9/10 (Vera LLM concurrency cap, sequences limit, batch menu inserts), SEO-2/3/8/9 (per-entity OG for circles/journeys/spotlight, pillar OG cards) | claude | Triaged | per [SITE-AUDIT-2026-06-29.md](SITE-AUDIT-2026-06-29.md) §7 |
| IDEA-012 | 2026-06-29 | Risk-gated backlog (needs consent/migration/owner): BUG-7 Stripe Connect activation gate (dormant), BUG-8 capstone-count SECURITY DEFINER RPC (migration), INF-2 Auth leaked-password protection (owner config), INF-3 schedule the `maintenance` skill | claude | Triaged | Hardening / per [SITE-AUDIT-2026-06-29.md](SITE-AUDIT-2026-06-29.md) §6 |
