...
> ⚠️ **Stale — superseded (2026-06-15). Not the live plan.** This list trails reality
> (many §A–§F items are already shipped). The one list is [`BUILD-BACKLOG.json`](BUILD-BACKLOG.json).
...
> [`AUDIT-2026-06-15.md`](AUDIT-2026-06-15.md) is a frozen snapshot. Keep this file for history only.
