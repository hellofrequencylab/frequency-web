...
| 2 | **Constrain reading measure to ~50–75 characters/line (~66 ideal); body ≥16px.** | Baymard line-length; Bringhurst canon; NN/g glanceable type |
...
streak with a **freeze** (a missed day shouldn't reset momentum — Lally 2010; Duolingo).

**Knowledge-check.** Inline question + options, **instant correct/incorrect feedback + retry**, no
penalty, framed as "check your understanding" (formative, anxiety-lowering — Agarwal 2014).
...
14. Reich & Ruipérez-Valiente (2019), *The MOOC Pivot* (Science) — real self-paced completion (~3–6%).
