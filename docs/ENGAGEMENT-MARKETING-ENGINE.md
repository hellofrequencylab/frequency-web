...
Status: **Phases A to C shipped (pipeline + dashboard + outcomes).** Decision: [ADR-070](DECISIONS.md).
...
**The one idea:** this is a Studio *face* on what we already own. It is **not** a fourth parallel
