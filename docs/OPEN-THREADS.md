...
| A7 | **Apply the 2026-06-25 security migrations to prod** | 🧑 | The full-site survey ([`AUDIT-2026-06-25.md`](AUDIT-2026-06-25.md)) shipped three migrations: `20260818000100` (revoke the `dashboard_*_summary` IDOR grant — a **live**, PostGREST-reachable hole until applied), `20260818000000` (fix the always-false Space DB gates), `20260818000200` (listings `WITH CHECK`). | Apply via Supabase MCP / dashboard and record it (as ADR-371 did); the repo files don't retroactively change the live grant/predicate. |
