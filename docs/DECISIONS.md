...
**Status:** Parts 1 + 2 Accepted + shipped (2026-06-16); Part 3 (Side Quests) PLANNED. — "Make the journey practices the 4 pillars. Mind, Body, Spirit and Expression. Add challenges as 'extra credit' above and beyond the journey that counts towards regular points. Somewhere in gamification we should have Side Quests: reward based, not counting towards the 4 pillars, a special badge for finishing one." Supersedes ADR-299's "Expression as a challenge-style slot."
