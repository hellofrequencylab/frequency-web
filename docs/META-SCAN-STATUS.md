...
| 2 | scan follow-through | **SCAN-638** | File is `20270345006500_advisor_space_fk_indexes_and_initplan.sql` (ADR-1445). Apply after merge with execute_sql then a schema_migrations insert at that version. No `spatial_ref_sys`. |
