...
> 🔴 **Superseded in part by [ADR-149](DECISIONS.md) (2026-06-06): Journeys are now FREE.**
...
> open library vs "Quests" = `quest_chains` engine; ADR-149 collapses them.)
...
| **Journeys** (the tracked, all-in-one flow) | ✅ *(free — ADR-149)* | ✅ |
...
> 🔴 **Superseded by [ADR-149](DECISIONS.md): Journeys are free.** This section described
