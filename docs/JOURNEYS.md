...
[ADR-1397](DECISIONS.md) through [ADR-1405](DECISIONS.md). Built on a five-angle evidence review of
...
`space_tier_id` (optional enrol gate onto one Space membership, LIVE-411 / ADR-1472).
