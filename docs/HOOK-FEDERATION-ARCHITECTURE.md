...
- Only the **public face** is visible to the wider network/crawlers — mirrors Frequency's posture:
...
- **Versioning:** the contract is versioned — a Hook schema change can't break a Frequency deploy;
...
| `account_links` table · points-rollup endpoint · channel-federation registry · subdomain hosting | **[to build, §8.0–8.3]** |
