...
// (ADR-514). Mirrors the render-boundary pattern of module-map.tsx: the pure module registry
// (lib/admin/modules/registry.ts) stays free of React/Supabase; this map closes the loop at the client
