    ...
    <div className="@container space-y-3">
      ...
      >
        <span className="min-w-0 flex-1">
          <span className="block text-body-sm font-semibold text-text">Open the builder</span>
          <span className="block text-meta text-muted">Arrange the Phase, Module, and Lesson structure and the discovery layout.</span>
        </span>
