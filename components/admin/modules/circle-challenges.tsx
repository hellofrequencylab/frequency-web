      ...
      {adopted.length === 0 ? (
        ...
        <ul className="space-y-2">
          {adopted.map((c) => {
            ...
            return (
              <li key={c.id} className="rounded-control border border-border bg-surface px-3 py-2">
      ...
      {adoptable.length > 0 && (
        <div className="flex items-center gap-2 flex-wrap pt-1">
          ...
          <button
            ...
            className="rounded-control bg-primary hover:bg-primary-hover text-on-primary px-3 py-1.5 text-body-sm font-semibold disabled:opacity-60 transition-colors"
          >
