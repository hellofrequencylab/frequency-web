  ...
  return (
    <div ref={ref} className="relative shrink-0">
      <button
        ...
        aria-label="Create"
        aria-expanded={open}
        className="inline-flex items-center gap-1.5 rounded-lg bg-primary hover:bg-primary-hover text-white text-sm font-semibold px-4 py-2 shadow-sm transition-colors"
      >
