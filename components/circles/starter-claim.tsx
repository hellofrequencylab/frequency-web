...
// (a claim mints a Circle you host, ADR-891). circle.create is open to any
// signed-in member; LIVE-409 dropped the CrewGate wrapper on this banner.
export function StarterClaim({
  templateId,
}: {
  templateId: string
  /** @deprecated Claiming a Starter Circle is a Circle compose act (LIVE-409). Drop it at the call sites. */
  canCreate?: boolean
}) {
