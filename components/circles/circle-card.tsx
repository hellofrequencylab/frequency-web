    ...
    <EntityCard
      ...
      action={
        circle.isStarter ? (
          <Link
            href={href}
            className="inline-flex rounded-control bg-primary px-3 py-1.5 text-meta font-semibold text-on-primary lift-1 transition-colors hover:bg-primary-hover"
          >
            Remix
          </Link>
        ) : isMember ? (
          ...
          <JoinCircleButton
            ...
            className="rounded-control bg-primary px-3 py-1.5 text-meta font-semibold text-on-primary lift-1 transition-colors hover:bg-primary-hover"
          />
        ) : (
          <span className="inline-flex rounded-control bg-surface px-3 py-1.5 text-meta font-medium text-muted lift-1 ring-1 ring-border">
            Full
          </span>
        )
      }
