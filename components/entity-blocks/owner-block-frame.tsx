  ...
  return (
    <div className="group relative [&:not(:has(section:not(:empty)))]:hidden">
      ...
      <Link
        ...
        className="absolute right-2 top-2 z-10 inline-flex h-8 w-8 items-center justify-center rounded-pill border border-border bg-surface text-muted opacity-0 lift-1 transition hover:text-text focus-visible:opacity-100 group-hover:opacity-100"
      >
