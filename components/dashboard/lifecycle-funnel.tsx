          ...
          return (
            <div key={step.key}>
              ...
              <Link
                ...
                className="group flex items-center gap-3 rounded-card px-2 py-1.5 transition-colors hover:bg-surface-elevated/60"
              >
      ...
      <div className="mt-4 grid grid-cols-2 gap-2 border-t border-border pt-4">
        {LEAK.map((step) => (
          <Link
            key={step.key}
            href={`${drillBase}?stage=${step.stage}`}
            className="group flex items-center justify-between rounded-card bg-surface-elevated/60 px-3 py-2 transition-colors hover:bg-surface-elevated"
          >
