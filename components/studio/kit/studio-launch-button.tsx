  ...
  return (
    <>
      <button
        type="button"
        onClick={() => set(true)}
        className={className ?? 'inline-flex items-center gap-1.5 rounded-control bg-primary px-4 py-2 text-body-sm font-semibold text-on-primary transition-colors hover:bg-primary-hover'}
      >
