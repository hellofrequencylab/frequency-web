...
export function StudioNote({ children, className }: { children: ReactNode; className?: string }) {
  return (
    <div className={`flex items-start gap-2 rounded-control border border-border bg-surface-elevated/60 px-3 py-2 text-meta leading-relaxed text-muted ${className ?? ''}`}>
