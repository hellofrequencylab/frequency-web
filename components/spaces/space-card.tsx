      ...
      coverAction={
        space.action ? (
          ...
          <Link
            ...
            className="inline-flex items-center gap-1 rounded-control px-1.5 py-0.5 text-meta font-semibold text-on-ink underline decoration-1 underline-offset-2 backdrop-blur-sm hover:decoration-2"
          >
            {space.action.label}
