...
// ADMIN PRODUCTION CONSOLE (ADR-1445 C1–C3, ADR-1450, ADR-1454, ADR-1458). The operator list
// on a Space Calendar tab in Admin mode. pencilLane is C2. planningLane is C3. Production
// stays on the mixed board until C4. The month grid is the date map (passed as children,
