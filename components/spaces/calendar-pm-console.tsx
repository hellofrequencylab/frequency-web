...
// ADMIN PRODUCTION CONSOLE (ADR-1445 C1–C3, ADR-1450, ADR-1454, ADR-1460). The operator list
      ...
      <section aria-labelledby="calendar-pm-planning" data-planning-lane>
        ...
        {planning.length === 0 ? (
          <EmptyState
            ...
            description="Move a Pencil here when the date is decided. The team is putting it together."
          />
        ) : (
