...
// ADMIN PRODUCTION CONSOLE (ADR-1445 C1–C3, ADR-1450, ADR-1454, ADR-1466). The operator list
      ...
      <section aria-labelledby="calendar-pm-planning" data-planning-lane>
        ...
        {planning.length === 0 ? (
          <EmptyState
            ...
            description="The date is decided and the team is putting it together. Move a Pencil here once you keep a date."
          />
        ) : (
