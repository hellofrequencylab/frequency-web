...
export const ACCENT_CLASSES: Record<StepAccent, { solid: string; onSolid: string; soft: string; text: string }> = {
  ...
  success: { solid: 'bg-success', onSolid: 'text-on-primary', soft: 'bg-success-bg', text: 'text-success' },
  warning: { solid: 'bg-warning', onSolid: 'text-on-primary', soft: 'bg-warning-bg', text: 'text-warning' },
