...
export function DemoToggle({
  ...
  return (
    <button
      ...
      className="hidden items-center gap-1.5 rounded-pill border border-border bg-surface-elevated/70 py-1.5 pl-3 pr-1.5 text-body-sm font-semibold text-muted transition-colors hover:border-border-strong hover:text-text sm:inline-flex"
    >
