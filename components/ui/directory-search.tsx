  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        disabled={disabled}
        className="w-full rounded-card border border-border bg-surface py-2.5 pl-10 pr-9 text-sm text-text placeholder:text-subtle transition-colors focus:border-border-strong focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
      />
      {value && (
        <button
          type="button"
