...
// Spark ⚡ / Current 🌊 / Deep 🏔️. Tier never affects Zap or streak math — it only
...
export const TIER_META: Record<IntensityTier, TierMeta> = {
  spark: { tier: 'spark', label: 'Spark', glyph: '⚡', blurb: 'Minimum viable — the worst-day version.' },
  current: { tier: 'current', label: 'Current', glyph: '🌊', blurb: 'Standard. The default depth.' },
  deep: { tier: 'deep', label: 'Deep', glyph: '🏔️', blurb: 'Full expression — the deepest take.' },
}

export const TIER_ORDER: readonly IntensityTier[] = ['spark', 'current', 'deep']
