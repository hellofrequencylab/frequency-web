  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-label="Create"
        aria-expanded={open}
        className="inline-flex items-center gap-1.5 rounded-lg bg-primary hover:bg-primary-hover text-on-primary text-body-sm font-semibold px-3 py-1.5 lift-1 transition-colors"
      >
