  ...
  return (
    <div className="relative">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        aria-expanded={open}
        className="inline-flex items-center gap-2 rounded-control border border-border px-3 py-2 text-body-sm font-medium text-muted transition-colors hover:bg-surface-elevated hover:text-text"
      >
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 z-20 mt-2 w-80 max-w-[calc(100vw-2rem)] rounded-card border border-border bg-surface p-4 shadow-pop">
            ...
            <div className="mt-3 flex flex-col gap-2">
              <a
                href={webcalUrl}
                className="inline-flex items-center justify-center gap-2 rounded-control bg-primary px-3 py-2 text-body-sm font-semibold text-on-primary transition-colors hover:bg-primary-hover"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-control border border-border px-3 py-2 text-body-sm font-medium text-text transition-colors hover:bg-surface-elevated"
              >
              ...
              <button
                type="button"
                onClick={copy}
                className="inline-flex items-center justify-center gap-2 rounded-control border border-border px-3 py-2 text-body-sm font-medium text-muted transition-colors hover:bg-surface-elevated hover:text-text"
              >
