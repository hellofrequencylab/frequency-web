...
export function AddToCalendar({
    ...
    return (
      <div className="flex items-center gap-2">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 rounded-control border border-border bg-surface px-3 py-1.5 text-meta font-medium text-muted transition-colors hover:border-border-strong hover:text-text"
        >
  ...
  return (
    <div className="flex items-center gap-2">
      <Link
        href={icsHref}
        className="inline-flex items-center gap-1.5 rounded-control border border-border px-3 py-1.5 text-meta font-medium text-muted transition-colors hover:border-border-strong hover:bg-surface"
        title="Apple Calendar, Outlook, and any iCal-compatible app"
      >
