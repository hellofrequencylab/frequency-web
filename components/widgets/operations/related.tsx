...
// Operations layout module (LP7): the "Related areas" cross-link strip. Self-fetching RSC that reads
// the viewer's own roles (community, staff web_role, operations staff role) to filter the neighboring
...
export async function OperationsRelated() {
