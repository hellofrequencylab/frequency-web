    ...
    return (
      <div className="flex items-center gap-1">
        <input
          ...
          autoFocus
          disabled={isPending}
          className="text-meta rounded border border-border bg-surface px-2 py-0.5 outline-none focus:border-border-strong focus:ring-1 focus:ring-border-strong/30 max-w-[200px]"
        />
