    ...
    <section className="overflow-hidden rounded-2xl border border-warning/40 bg-gradient-to-b from-warning-bg/80 to-warning-bg/30 lift-1">
      ...
      <div className="flex items-center gap-2.5 border-b border-warning/20 bg-warning-bg/60 px-3.5 py-3">
        ...
        <div className="min-w-0">
          <h3 className="text-body-sm font-extrabold uppercase tracking-wide text-warning">Help build it</h3>
      ...
      <div className="px-3.5 py-3">
        <p className="text-body-sm leading-snug text-subtle">
          Anything with a{' '}
        ...
        <ul className="mt-2.5 space-y-1">
          {ACTIONS.map((a) => (
            <li key={a.href}>
              ...
              >
                <span className="text-body-sm font-medium text-text transition-colors group-hover:text-warning">{a.label}</span>
                <span className="inline-flex shrink-0 items-center gap-0.5 text-meta font-extrabold text-warning tabular-nums">
                  +{a.zaps}
