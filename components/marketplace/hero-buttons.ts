...
export const HERO_SECONDARY_BTN =
  'inline-flex items-center gap-1.5 whitespace-nowrap rounded-lg border border-white/30 bg-white/10 px-3 py-2 text-meta font-semibold text-on-ink transition-colors hover:bg-white/20 sm:px-4 sm:text-body-sm'
