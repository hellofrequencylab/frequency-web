...
export const HERO_PRIMARY_BTN =
  'inline-flex items-center gap-1.5 whitespace-nowrap rounded-lg bg-primary px-3 py-2 text-meta font-semibold text-on-primary transition-colors hover:bg-primary-hover sm:px-4 sm:text-body-sm'

/** The secondary, on-ink action riding the dark hero image (Manage / My drafts). */
export const HERO_SECONDARY_BTN =
  'inline-flex items-center gap-1.5 whitespace-nowrap rounded-lg border border-on-ink/30 bg-on-ink/10 px-3 py-2 text-meta font-semibold text-on-ink transition-colors hover:bg-on-ink/20 sm:px-4 sm:text-body-sm'
