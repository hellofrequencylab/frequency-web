...
const BUTTON =
  'inline-flex h-9 w-9 items-center justify-center rounded-pill border border-border bg-surface/90 text-muted lift-1 backdrop-blur transition-colors hover:text-text'
