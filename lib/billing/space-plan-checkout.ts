...
const PLAN_FLAG: Record<SpacePlanKey, 'plan_practitioner_enabled' | 'plan_business_enabled' | 'plan_brand_enabled' | 'plan_nonprofit_enabled' | 'plan_organization_enabled' | 'plan_whitelabel_enabled'> = {
  practitioner: 'plan_practitioner_enabled',
  business: 'plan_business_enabled',
  brand: 'plan_brand_enabled',
