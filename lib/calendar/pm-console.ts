...
// THE ADMIN OPERATOR LIST (ADR-1445 C1–C3, ADR-1450, ADR-1454, ADR-1460). What the Calendar
// tab's Admin mode lists above the month. pencilLane is the C2 Pencil lane. planningLane is
// the C3 Planning lane. Production stays on the mixed board until C4 (LIVE-418). Private
// entries and Unavailable time stay on the date map (StaffCalendar).
...
// C3 (LIVE-417, ADR-1460). Planning-stage gatherings as their own lane. The date is decided
// and the team is putting it together (NAMING.md). Production stays on the board (LIVE-418).
