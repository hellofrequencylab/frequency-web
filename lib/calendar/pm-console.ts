...
// THE ADMIN OPERATOR LIST (ADR-1445 C1–C3, ADR-1450, ADR-1454, ADR-1468). What the Calendar
...
// C3 (LIVE-417, ADR-1468). Planning-stage gatherings as their own lane. The date is decided
// and the team is putting it together (NAMING.md). Guest never sees these (LIVE-419).
