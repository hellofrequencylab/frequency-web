...
export interface Space {
  ...
  /** Display brand name (falls back to `name` when null). Header wiring is a follow-up. */
  brandName: string | null
  /** Same-origin or https URL of the Space's brand logo. Header wiring is a follow-up. */
