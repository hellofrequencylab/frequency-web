...
export const FEATURE_KEYS: FeatureKey[] = [
  ...
  { key: 'crm', label: 'CRM / contacts', area: 'operator', routes: ['/admin/crm'], core: false },
  { key: 'profiles', label: 'Profile Creator (network intake)', area: 'operator', routes: ['/connections'], core: false },
  { key: 'marketing', label: 'Marketing console', area: 'operator', routes: ['/admin/marketing'], core: false },
