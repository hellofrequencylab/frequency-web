...
// "where can I buy X". Price in major units, 2dp, currency upper-cased (mirrors the
// Event Offer). The item Detail page renders this via the <JsonLd> component.
...
// Rent is an Offer with a monthly UnitPriceSpecification.
