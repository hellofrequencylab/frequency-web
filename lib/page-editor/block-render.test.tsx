...
describe('BlockRender golden markup (frozen; was byte-identical to Puck rsc <Render>)', () => {
  ...
  it('threads metadata through the config root (space layout preset wraps children)', () => {
    ...
    expect(withSpace).toMatchInlineSnapshot(`"<div class="space-y-16 py-10 sm:space-y-20 sm:py-14"><section class="px-6 py-16 sm:py-20 bg-surface "><div class="max-w-3xl mx-auto "><p data-text-role="eyebrow" class="font-eyebrow text-body-sm font-bold uppercase tracking-[0.25em] mb-4 text-primary-strong">Eyebrow</p><h2 class="font-display uppercase text-balance text-[clamp(1.875rem,5.5vw,3rem)] text-text">Space page</h2></div></section></div>"`)
    expect(withoutSpace).toMatchInlineSnapshot(`"<section class="px-6 py-16 sm:py-20 bg-surface "><div class="max-w-3xl mx-auto "><p data-text-role="eyebrow" class="font-eyebrow text-body-sm font-bold uppercase tracking-[0.25em] mb-4 text-primary-strong">Eyebrow</p><h2 class="font-display uppercase text-balance text-[clamp(1.875rem,5.5vw,3rem)] text-text">Space page</h2></div></section>"`)
  })
