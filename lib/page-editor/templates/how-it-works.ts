  ...
  content: [
        ...
        items: [
          {
            ...
            body: 'Choose an Interest — movement, breathwork, holistic health, creativity, human relating. It\'s the thread that ties you to people who care about the same thing.',
            href: '',
          },
          {
            icon: 'Users',
            image: '',
            title: 'Join a Circle',
            body: 'Find your people near you. A small group built around your Interest, with an always-on virtual space and a standing time to meet in person.',
            href: '',
          },
          {
            icon: 'CalendarDays',
    ...
    // ── Interests and Circles ────────────────────────────────────────────────
    {
      ...
      props: {
        ...
        body: "An **Interest** is what you practice: movement, breathwork, holistic health, creativity, human relating. It connects you to people everywhere who care about the same things you do.\n\nA **Circle** is your people, near you. A small group built around an Interest, with an always-on virtual space, and often a standing time to meet in person. Small enough that you're missed when you don't show up.",
        side: 'left',
        imgAspect: 'landscape',
        focal: 'center',
        ctaLabel: '',
        ...
        items: [
          {
            ...
            image: '',
            title: 'A Circle',
            body: 'A handful of neighbors around one Interest. The smallest unit that can hold you.',
            href: '',
          },
          {
            icon: 'MapPin',
