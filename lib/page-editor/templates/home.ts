  ...
  content: [
    ...
    // a lawn at golden hour, a real gathering, not a crowd. ──────────────────────
    {
      ...
      props: {
        ...
        titleAccent: 'Tuesday',
        subtitle:
          'Frequency is community you build where you live. A few neighbors, a standing time, and a room that misses you when you are gone. The first rooms start now.',
        ...
        ctaSecondaryLabel: '',
        ctaSecondaryHref: '',
        note: 'We are just opening. The first Hosts set the tone.',
        tone: 'surface',
        width: 'default',
        align: 'center',
        layout: L,
    ...
    },
    {
      ...
      props: {
        id: 'home-answer-b',
        body: 'Frequency hands you the rails that real connection needs and almost no one has: a format, a script, a standing time, and the backup so you are never out front alone. You bring a Channel you care about and a few people near you. We bring the rest.\n\nIt starts in living rooms and parks, the way it always has. You do not have to wait for a building to open to start a Circle this week.',
        size: 'lg',
        tone: 'surface',
        width: 'default',
        align: 'left',
    ...
    // night, and the ladder. Ask here. Not ink (the single dark beat is below). ──
    {
      ...
      props: {
        ...
        body: 'You have seen the structure, the night, and the ladder. The first Hosts are setting the tone now.',
    ...
    // Image: playful lawn hula-hooping, the proof that a community can be joy. ────
    {
      ...
      props: {
        ...
        eyebrow: 'Who we are calling in',
        title: 'The people who start things.',
        titleAccent: 'start things',
        kicker: 'You are not waiting for the place to appear. You are ready to make it happen.',
        body: 'This is a movement of people building real connection where they live, and it only works if we build it together. You do not need a big personality or a finished plan. You need a Channel you care about, a few people near you, and a format you can run.\n\nWe hand you the rest, and a whole ladder of people who have your back. Start one Circle, and you are not on your own. You are part of a community of builders, holding doors open in their own towns at the same time.',
        side: 'right',
        imgAspect: 'landscape',
        focal: 'center',
        ctaLabel: '',
    ...
    // ── Close ── the ink CTA. Primary action plus the quiet member path. ────────
    {
      ...
      props: {
        ...
        body: 'No members yet, no waitlist theater. Find a few neighbors, pick what you practice, and hold the door for one Circle. We will bring you in as the first rooms take shape near you.',
        ctaPrimaryLabel: BETA_CTA_LABEL,
        ctaPrimaryHref: BETA_CTA_HREF,
        ctaSecondaryLabel: BETA_CTA_SECONDARY_LABEL,
        ctaSecondaryHref: BETA_CTA_SECONDARY_HREF,
