  ...
  content: [
    ...
    // no narrating their feelings. ──────────────────────────────────────────────
    {
      ...
      props: {
        ...
        title: 'You do the work. The tools take a cut of it.',
        titleAccent: 'take a cut',
        kicker: "It's not you. The old deal just stopped working for the people who build community.",
        size: 'default',
        tone: 'canvas',
        width: 'default',
        align: 'left',
    ...
    },
    {
      ...
      props: {
        id: 'home-problem-b',
        body: "You can switch platforms, cities, and payment tools and still lose the same slice every month: a cut of the bookings you brought in yourself, and a community scattered across a dozen apps that don't talk to each other.\n\nMost tools were built to sit between you and your people and charge for the privilege. That's backwards. The people who gather everyone else should keep what they earn and own who they gather.",
        size: 'lg',
        tone: 'canvas',
        width: 'default',
        align: 'left',
    ...
    // rails real-world connection needs. ────────────────────────────────────────
    {
      ...
      props: {
        ...
        titleAccent: 'run',
        kicker: 'Not another tool that sits between you and your people. A Collective built to help your effort succeed.',
        size: 'default',
        tone: 'surface',
        width: 'default',
        align: 'left',
    ...
    },
    {
      ...
      props: {
        id: 'home-answer-b',
        body: "Frequency hands you the rails that real community needs and almost no one gives you: a format, a script, a standing time, and the backup so you're never out front alone. You bring a Channel you care about and a few people near you. We bring the rest.\n\nOne honest monthly price covers it. Your own bookings stay yours at 0%, always, and you can leave any time and take your data and your Contacts with you.",
        size: 'lg',
        tone: 'surface',
        width: 'default',
        align: 'left',
    ...
    // ── Close ── the ink CTA. Primary action plus the quiet member path. ────────
    {
      ...
      props: {
        ...
        body: "No members yet, no waitlist theater. Find a few neighbors, pick what you practice, and hold the door for one Circle. You keep what you earn, you can leave any time with your data, and we'll bring you in as the first rooms take shape near you.",
        ctaPrimaryLabel: BETA_CTA_LABEL,
        ctaPrimaryHref: BETA_CTA_HREF,
        ctaSecondaryLabel: BETA_CTA_SECONDARY_LABEL,
        ctaSecondaryHref: BETA_CTA_SECONDARY_HREF,
