  ...
  content: [
    ...
    // the third place that quietly disappeared. Plain, not clinical. ─────────────
    {
      ...
      props: {
        ...
        kicker: 'It is not just you. The places adults used to meet quietly disappeared.',
        size: 'default',
        tone: 'canvas',
        width: 'default',
        align: 'left',
    ...
    },
    {
      ...
      props: {
        id: 'ab-problem-b',
        body: "Most of us are more connected and more alone than people have ever been. The feed promised company and handed us a screen. Meanwhile the places that held a life together kept closing: the corner cafe, the rec league, the standing time with the same faces. The third places that are not home and not work are the infrastructure friendship runs on, and most of us watched them go without noticing until they were gone.\n\nNobody is coming to fix that for us. No app, no algorithm, no company is going to hand the third place back. Roads, water, power: nobody throws a party about infrastructure, but nothing works without it. Connection is the same, and right now it is missing.",
        size: 'lg',
        tone: 'canvas',
        width: 'default',
        align: 'left',
    ...
    // forward, guru-free. The trust beat, said as three plain promises. ─────────
    {
      ...
      props: {
        ...
        kicker: 'A community built around one charismatic founder lives and dies with that person. We have all watched it happen, so this is built to be the opposite.',
        size: 'default',
        tone: 'canvas',
        width: 'default',
        align: 'left',
      ...
      props: {
        ...
        items: [
          ...
          },
          {
            ...
            body: 'People who can give more keep the doors open for people who cannot. The Frequency Lab funds the free side, the money goes back into the room, and nobody is priced out of belonging.',
            href: '',
          },
          {
            icon: '',
            image: '',
            title: 'Guru-free',
            body: 'A real person started this, and it is built to not need him. If the format works in a stranger’s living room with none of us in the room, we have done our job. That is the bar.',
            href: '',
          },
        ],
        tone: 'canvas',
    ...
    },
    {
      ...
      props: {
        id: 'ab-stmt-2',
        text: 'You do not need permission to gather people. You need rails. We hand you the rails.',
        accent: 'rails',
        tone: 'surface',
        layout: L,
      },
    ...
    // spoken straight to the Latent Leader. ONE ink section before the close. ────
    {
      ...
      props: {
        ...
        title: 'If you are the one who gathers people, this is for you.',
        titleAccent: 'gathers people',
        kicker: '',
        body: "You know who you are. You are the one who texts the group, sets the time, holds the door. Maybe you tried hosting something once and it fizzled, and you carried that quietly. The fizzle was never about you. It was about doing it alone with no format and no backup.\n\nSo we are calling you in. Bring the people you already care about, pick a Channel, and run one Circle. We hand you the format, the script, and the backup, and we would rather be judged on what we hand you than on who we are. This is a space we can all exist in and hold open for each other. We do not want to be followed. We want to be joined.",
        side: 'left',
        imgAspect: 'landscape',
        focal: 'center',
        ctaLabel: '',
    ...
    // quiet member path for the Seeker. ─────────────────────────────────────────
    {
      ...
      props: {
        ...
        body: 'This time it gets a home, and it gets you. Find a few people near you, pick what you practice, and hold the door for one Circle. We will point you at the first move.',
