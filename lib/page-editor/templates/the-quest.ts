  ...
  content: [
    ...
    // Journeys (Mind, Body, Spirit), each capped by an Expression Challenge. ────
    {
      ...
      props: {
        ...
        capstoneNote: "Expression is not a fourth Journey. It is the Challenge that closes each leg: make something, share it with your people, and finish the Journey. Three Journeys, three Challenges, one season. A new Quest drops with each season: Stretch in summer, Shed in autumn, Sit in winter, Sprout in spring.",
        tone: 'canvas',
        width: 'wide',
        align: 'left',
        layout: L,
    ...
    },
    {
      ...
      props: {
        ...
        items: [
          ...
          { icon: 'Flame', image: '', title: 'Amplitude', body: 'Your lifetime total of every Zap you have ever earned. It never resets and never gets spent. It just keeps a record of the long haul.', href: '' },
        ],
        tone: 'surface',
        width: 'default',
        align: 'left',
