...
const MEMBER_FOOTER_COLUMNS: readonly { title: string; links: readonly MemberFooterSeed[] }[] = [
  {
    ...
    links: [
      ...
      { id: 'market', label: 'Marketplace', href: '/market', navKey: 'market' },
      { id: 'housing', label: 'Housing', href: '/marketplace/housing', navKey: 'housing' },
      { id: 'maker', label: 'Makers', href: '/marketplace/makers', navKey: 'maker' },
      { id: 'shop', label: 'Shop', href: '/shop', navKey: 'shop' },
