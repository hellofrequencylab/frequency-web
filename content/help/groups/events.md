...
- **Manage screen.** One dashboard for your whole event, organized in tabs. Home opens with your numbers at a glance and a message center where you can look up any attendee and message them directly. Guests holds the full list, the waitlist, and approvals; the other tabs cover your questionnaire (with export), tickets, updates, and the event's settings. You reach it from the event page or the event's editor.
