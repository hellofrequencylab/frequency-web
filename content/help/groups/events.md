...
- **Your Space calendar is a manager.** On the Space Calendar tab, Admin is the production board. Pencil is its own lane. Planning, Production, and Cancelled stay on the board, with the month underneath as the date map. Guest is live events only. Pencil and planning stay on Admin. In Calendar settings you still flip the month grid and a list, click any event to edit it, and handle co-host requests. Drafts and past events show there too.
