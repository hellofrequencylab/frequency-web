...
- **Your Space calendar is a manager.** On the Space Calendar tab, Admin is the production board. Pencil and Planning are their own lanes. Production and Cancelled stay on the board, with the month underneath as the date map. Guest is what visitors see: live events only, and a cancelled gathering as a small note on that day. Dates that are only penciled or still in planning stay off Guest. In Calendar settings you still flip the month grid and a list, click any event to edit it, and handle co-host requests. Drafts and past events show there too.
