...
- **The answer switch is there on a ticketed event too**, under the Tickets box. Tap **Going** before you have a ticket and it opens the card fields instead of recording an answer, because on these events the ticket is the answer. **Interested** and **Can't go** you can give either way, ticket or no ticket, and the host reads them.
