...
Log **any** practice and today counts. Do it again tomorrow and your streak ticks
up. You only need one practice a day to keep it — logging more is great, but it
won’t double-count.

A new badge lands at each checkpoint — **3, 7, 14, 30, 60, 100 and 365 days** — and
each one pays **zaps** (which drive your season rank). The further you go, the bigger
the reward.

## Streak freezes

Life happens. When you reach the **Week, Month, Century and Year** milestones you
bank a **freeze** (up to two at a time). If you miss a single day, a freeze is spent
automatically the next time you log — so one slip never wipes out the momentum you’ve
built. Miss two days in a row and the streak resets to one.
