...
PRODUCT-FIRST (ADR-1403). Prefer LIVE-410 (memberships on Connect readiness, not Business plan). LIVE-376 closed (sole-Space default, ADR-1413). LIVE-234 is P0 money proof and is owner-walked. LIVE-408 needs an owner ruling. Journey sales (LIVE-392+) is claimed by ${FOREIGN_LANE_CLAIMS.journey}.
