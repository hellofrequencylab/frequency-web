...
TWO-AGENT SPLIT (2026-09-19, meta.slate.metaScanCleanup). If you are the product agent already on the backlog: take derived lanes money then events. Do not take lane \`scan\`. If you are the scan follow-through agent: \`pnpm packets --lane scan\` and start SCAN-641 (SCAN-636/637/638 closed). Do not take LIVE-376 or LIVE-234. LIVE-412 is on the scan lane (shell split after SCAN-641), not a free shell packet.
`
