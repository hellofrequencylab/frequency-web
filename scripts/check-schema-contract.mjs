...
export const ALLOWLIST = [
  ...
  ...[
    ...
    added: '2026-09-19',
    reason:
      'ADR-1468 Space Plans. Columns and tables ship in 20270345006600 and are not in the checked-in generated types until the migration is applied and types regenerate. Do not apply from an agent session.',
    owner: 'PROG-CAL2',
  })),
]
